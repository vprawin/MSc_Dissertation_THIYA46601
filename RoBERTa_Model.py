"""MSc Dissertation — RoBERTa_Model.py
    ...
    RoBERTa-based model training and evaluation utilities.
...
# ==================== MODEL ===================: Description.
    ...
    Returns:
        Description of return value.
    """
    def __init__(self, roberta_model_name, num_labels, num_place, num_type, emb_dim=32):
        """__init__ — one-line summary.

    Args:
        roberta_model_name: Description.
    ...
    """
        ...
        combined_dim = self.roberta.config.hidden_size + emb_dim * 2
